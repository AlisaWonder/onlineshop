...
tabsItem.forEach(function (item) {
	item.addEventListener("click", function () {
		let currentTabsItem = item;
		let tabId = currentTabsItem.getAttribute("data-tab");
		let currentTab = document.querySelector(tabId);
		if (!currentTabsItem.classList.contains('active')) {
			tabsItem.forEach(function (item) {
		...
		currentTabsItem.classList.add('active');
...
//закончили определять устройство
// Меню бургер
